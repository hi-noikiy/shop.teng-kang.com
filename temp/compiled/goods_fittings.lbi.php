			...
			<div class="master">
				...
				<div class="p-oper">
					<div class="dsc-enable">
						<input type="hidden" class="m_goods_<?php echo $this->_var['key']; ?>" stock="<?php echo $this->_var['goods']['group_number']; ?>" />
...
?>
			...
			<div class="combo-action">
                ...
                <div class="input_combo_stock">
                    <div id="combo_stock_number" class="hide"><?php echo $this->_var['lang']['limit_shop']; ?><font id="stock_number">23</font><?php echo $this->_var['lang']['tao']; ?></div>
                    <div class="mt10">
				...
				<div class="combo-btn">
					<a href="javascript:void(0);" rev='m_goods_<?php echo $this->_var['key']; ?>_<?php echo $this->_var['goods_id']; ?>_<?php echo $this->_var['region_id']; ?>_<?php echo $this->_var['area_id']; ?>' class="combo-btn-buynow ncs_buy">立即购买</a>
				</div>
			</div>
		</div>
		</form>
