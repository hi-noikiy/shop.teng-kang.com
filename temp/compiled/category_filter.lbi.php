        ...
        <div class="dorpdown-layer" id="area_list">
            ...
            <div id="stock_list" class="stock_list">
                ...
                <div class="mc" id="house_list">
                    ...
                    <?php $_from = $this->_var['province_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_97629800_1506354903');$this->_foreach['noprovince'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['noprovince']['total'] > 0):
    foreach ($_from AS $this->_var['province_0_97629800_1506354903']):
        $this->_foreach['noprovince']['iteration']++;
?>
                    <li>
                        <a v="<?php echo $this->_var['province_0_97629800_1506354903']['region_id']; ?>" title="<?php echo $this->_var['province_0_97629800_1506354903']['region_name']; ?>" onclick="region.getRegion(<?php echo $this->_var['province_0_97629800_1506354903']['region_id']; ?>, 2, city_list, this,<?php echo $this->_var['user_id']; ?>);" href="javascript:void(0);"><?php echo $this->_var['province_0_97629800_1506354903']['region_name']; ?></a>
                    </li>
