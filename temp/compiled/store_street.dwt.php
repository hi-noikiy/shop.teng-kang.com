                            ...
                            <div class="s-l-value">
                                <div class="s-l-v-list">
                                    <ul>
                                        ...
                                        <?php $_from = $this->_var['province_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_87413900_1506353885');if (count($_from)):
    foreach ($_from AS $this->_var['province_0_87413900_1506353885']):
?>
                                        <li <?php if ($this->_var['province_0_87413900_1506353885']['region_id'] == $this->_var['store_province']): ?>class="curr"<?php endif; ?>><a href="javascript:void(0);" data-val="<?php echo $this->_var['province_0_87413900_1506353885']['region_id']; ?>" data-type="search_city" data-region="1" ectype="street_area" ><?php echo $this->_var['province_0_87413900_1506353885']['region_name']; ?></a></li>
                                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                    </ul>
                                </div>
                            </div>
