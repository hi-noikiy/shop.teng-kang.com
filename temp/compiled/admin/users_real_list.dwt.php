                ...
                <div class="common-content">
                	...
                	<div class="list-div"  id="listDiv">
                    	...
                    	<table cellpadding="0" cellspacing="0" border="0">
                            ...
                            <tbody>
                                <?php $_from = $this->_var['users_real_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'users_real_list_0_85974600_1506353809');if (count($_from)):
    foreach ($_from AS $this->_var['users_real_list_0_85974600_1506353809']):
?>
                            	<tr>
                                    <td class="sign"><div class="tDiv"><input type="checkbox" name="checkboxes[]" value="<?php echo $this->_var['users_real_list_0_85974600_1506353809']['real_id']; ?>" class="checkbox" id="checkbox_<?php echo $this->_var['users_real_list_0_85974600_1506353809']['real_id']; ?>" /><label for="checkbox_<?php echo $this->_var['users_real_list_0_85974600_1506353809']['real_id']; ?>" class="checkbox_stars"></label></div></td>
                                    <td><div class="tDiv"><?php echo $this->_var['users_real_list_0_85974600_1506353809']['real_id']; ?></div></td>
                                    <td><div class="tDiv"><?php echo htmlspecialchars($this->_var['users_real_list_0_85974600_1506353809']['user_name']); ?></div></td>
                                    <td><div class="tDiv"><?php echo $this->_var['users_real_list_0_85974600_1506353809']['real_name']; ?></div></td>
                                    <td><div class="tDiv"><?php echo $this->_var['users_real_list_0_85974600_1506353809']['bank_mobile']; ?></div></td>
                                    <td><div class="tDiv"><?php echo $this->_var['users_real_list_0_85974600_1506353809']['self_num']; ?></div></td>
                                    <td><div class="tDiv"><?php if ($this->_var['users_real_list_0_85974600_1506353809']['review_status'] == 1): ?>审核通过<?php elseif ($this->_var['users_real_list_0_85974600_1506353809']['review_status'] == 2): ?>审核未通过<?php else: ?>未审核<?php endif; ?></div></td>
                                    <td class="handle">
                                        <div class="tDiv a2">
                                            <a href="user_real.php?act=edit&real_id=<?php echo $this->_var['users_real_list_0_85974600_1506353809']['real_id']; ?>&user_type=<?php echo $this->_var['user_type']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>" class="btn_edit"><i class="icon icon-edit"></i><?php echo $this->_var['lang']['edit']; ?></a>
                                            <a href="javascript:confirm_redirect('你确定要删除该会员的实名认证吗？', 'user_real.php?act=remove&real_id=<?php echo $this->_var['users_real_list_0_85974600_1506353809']['real_id']; ?>')" title="<?php echo $this->_var['lang']['remove']; ?>" class="btn_trash"><i class="icon icon-trash"></i><?php echo $this->_var['lang']['remove']; ?></a>
                                        </div>
                                    </td>
                                </tr>
                                <?php endforeach; else: ?>
