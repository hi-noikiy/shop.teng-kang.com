                            	...
                            	<tr>
									...
									<td>
                                        <div class="tDiv goods_list_info">
                                            <div class="img"><a href="../goods.php?id=<?php echo $this->_var['list']['goods_id']; ?>" target="_blank" title="<?php echo htmlspecialchars($this->_var['list']['goods_name']); ?>"><img src="<?php echo $this->_var['list']['goods_thumb']; ?>" width="60" height="60" /></a></div>
                                            <div class="desc">
                                                <div class="name">
                                                    <span title="<?php echo $this->_var['list']['goods_name']; ?>" data-toggle="tooltip" class="span"><?php echo $this->_var['list']['goods_name']; ?></span>
                                                </div>
												<?php if ($this->_var['list']['brand_name']): ?><p class="brand">品牌：<em><?php echo $this->_var['list']['brand_name']; ?></em></p><?php endif; ?>
                                            </div>        
                                        </div>
                                    </td>
