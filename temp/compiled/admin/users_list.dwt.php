                                    ...
                                    <dd>
                                        <div  class="select_w145 imitate_select">
                                            ...
                                            <ul>
                                               ...
                                               <?php $_from = $this->_var['user_ranks']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('k', 'user_ranks_0_46198000_1506407122');if (count($_from)):
    foreach ($_from AS $this->_var['k'] => $this->_var['user_ranks_0_46198000_1506407122']):
?>
                                               <li><a href="javascript:;" data-value="<?php echo $this->_var['k']; ?>"><?php echo $this->_var['user_ranks_0_46198000_1506407122']; ?></a></li>
