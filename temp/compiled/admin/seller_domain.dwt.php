...
?>
								...
								<td>
									<div class="tDiv">
										<div class="switch mauto <?php if ($this->_var['list']['is_enable']): ?>active<?php endif; ?>" onclick="listTable.switchBt(this, 'is_enable', <?php echo $this->_var['list']['id']; ?>)" title="是">
							    ...
							    <td class="handle">
                                    <div class="tDiv a2">
                                        ...
                                        <a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['list']['id']; ?>, '<?php echo $this->_var['lang']['domain_confirm']; ?>')" title="<?php echo $this->_var['lang']['remove']; ?>" class="btn_trash"><i class="icon icon-trash"></i><?php echo $this->_var['lang']['remove']; ?></a>
                                    </div>
								</td>
								</tr>
								<?php endforeach; else: ?>
