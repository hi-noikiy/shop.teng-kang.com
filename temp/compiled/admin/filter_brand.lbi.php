<div class="brand-top">
	<div class="letter">
		<ul>
			...
			<?php $_from = $this->_var['letter']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'letter_0_28854000_1506355508');if (count($_from)):
    foreach ($_from AS $this->_var['letter_0_28854000_1506355508']):
?>
            <li><a href="javascript:void(0);" data-letter="<?php echo $this->_var['letter_0_28854000_1506355508']; ?>"><?php echo $this->_var['letter_0_28854000_1506355508']; ?></a></li>
