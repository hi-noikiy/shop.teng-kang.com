                            ...
                            <div class="sort_tit">
                                ...
                                <div class="select_list select_w320" id="sortcommList">
                                    ...
                                    <ul>
                                        ...
                                        <?php $_from = $this->_var['recently_used_category']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'category_0_28044400_1506355508');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['category_0_28044400_1506355508']):
?>
                                        <li><a href="javascript:void(0);" data-value="<?php echo $this->_var['key']; ?>"><?php echo $this->_var['category_0_28044400_1506355508']; ?></a></li>
                                                ...
                                                <div class="brand-top">
                                                    <div class="letter">
                                                        <ul>
                                                            ...
                                                            <?php $_from = $this->_var['letter']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'letter_0_28077300_1506355508');if (count($_from)):
    foreach ($_from AS $this->_var['letter_0_28077300_1506355508']):
?>
                                                            <li><a href="javascript:void(0);" data-letter="<?php echo $this->_var['letter_0_28077300_1506355508']; ?>"><?php echo $this->_var['letter_0_28077300_1506355508']; ?></a></li>
                                                            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
