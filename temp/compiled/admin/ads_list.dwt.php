...
<body class="iframe_body">
	<div class="warpper">
    	<div class="title"><a href="javascript:;" ectype='goback' class="s-back">返回</a><?php if ($this->_var['ads_type'] == 1): ?>手机<?php else: ?>广告<?php endif; ?> - <?php echo $this->_var['ur_here']; ?></div>
        <div class="content">
...
?>
                            	<tr>
                                    ...
                                    <td><div class="tDiv" <?php if ($this->_var['list']['advance_date'] == 1): ?> style="color:#ff0000" <?php endif; ?>><?php echo $this->_var['list']['end_date']; ?></div></td>
