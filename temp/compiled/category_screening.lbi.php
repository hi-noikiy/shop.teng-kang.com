                    ...
                    <div class="s-l-value brand_select_more">
                        <div class="all_a_z">
                            <ul class="a_z">
                                ...
                                <?php $_from = $this->_var['letter']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'letter_0_86848100_1506353904');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['letter_0_86848100_1506353904']):
?>
                                <li data-key="<?php echo $this->_var['letter_0_86848100_1506353904']; ?>"><?php echo $this->_var['letter_0_86848100_1506353904']; ?></li>
                                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
