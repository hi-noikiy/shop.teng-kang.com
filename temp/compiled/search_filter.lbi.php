        ...
        <div class="dorpdown-layer" id="area_list">
            ...
            <div id="stock_list" class="stock_list">
                ...
                <div class="mc" id="house_list">
                    ...
                    <?php $_from = $this->_var['province_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_87566700_1506353904');$this->_foreach['noprovince'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['noprovince']['total'] > 0):
    foreach ($_from AS $this->_var['province_0_87566700_1506353904']):
        $this->_foreach['noprovince']['iteration']++;
?>
                        <li>
                            <a v="<?php echo $this->_var['province_0_87566700_1506353904']['region_id']; ?>" title="<?php echo $this->_var['province_0_87566700_1506353904']['region_name']; ?>" onclick="region.getRegion(<?php echo $this->_var['province_0_87566700_1506353904']['region_id']; ?>, 2, city_list, this,<?php echo $this->_var['user_id']; ?>);" href="javascript:void(0);"><?php echo $this->_var['province_0_87566700_1506353904']['region_name']; ?></a>
                        </li>
...
?>
                ...
                <p class="mod_storage_state"><?php echo $this->_var['lang']['Distribution_limit']; ?></p>
    ...
    <div class="filter-range">
        ...
        <div class="fcheckbox">
                ...
                <div class="checkbox_item <?php if ($this->_var['pager']['search']['is_ship'] == 'is_shipping'): ?>checkbox-checked<?php endif; ?>">
                    ...
                    <i id="input-i1" rev="search.php?<?php if ($this->_var['cou_id']): ?>&cou_id=<?php echo $this->_var['cou_id']; ?><?php endif; ?>&keywords=<?php echo $this->_var['pager']['search']['keywords']; ?>&display=<?php echo $this->_var['pager']['display']; ?>&price_min=<?php echo $this->_var['price_min']; ?>&price_max=<?php echo $this->_var['price_max']; ?>&page=<?php echo $this->_var['pager']['page']; ?>&sort=<?php echo $this->_var['pager']['search']['sort']; ?>&is_ship=is_shipping<?php if ($this->_var['pager']['search']['self_support'] == 1): ?>&is_self=1<?php endif; ?><?php if ($this->_var['pager']['search']['have'] == 1): ?>&have=1<?php endif; ?>"></i>
                ...
                <div class="checkbox_item <?php if ($this->_var['pager']['search']['self_support'] == 1): ?>checkbox-checked<?php endif; ?>">
                    ...
                    <i id="input-i1" rev="search.php?<?php if ($this->_var['cou_id']): ?>&cou_id=<?php echo $this->_var['cou_id']; ?><?php endif; ?>&keywords=<?php echo $this->_var['pager']['search']['keywords']; ?>&display=<?php echo $this->_var['pager']['display']; ?>&price_min=<?php echo $this->_var['price_min']; ?>&price_max=<?php echo $this->_var['price_max']; ?>&page=<?php echo $this->_var['pager']['page']; ?>&sort=<?php echo $this->_var['pager']['search']['sort']; ?>&is_self=1<?php if ($this->_var['pager']['search']['is_ship'] == 'is_shipping'): ?>&is_ship=is_shipping<?php endif; ?><?php if ($this->_var['pager']['search']['have'] == 1): ?>&have=1<?php endif; ?>"></i>
                ...
                <div class="checkbox_item <?php if ($this->_var['pager']['search']['have'] == 1): ?>checkbox-checked<?php endif; ?>">
                    ...
                    <i id="input-i1" rev="search.php?<?php if ($this->_var['cou_id']): ?>&cou_id=<?php echo $this->_var['cou_id']; ?><?php endif; ?>&keywords=<?php echo $this->_var['pager']['search']['keywords']; ?>&display=<?php echo $this->_var['pager']['display']; ?>&price_min=<?php echo $this->_var['price_min']; ?>&price_max=<?php echo $this->_var['price_max']; ?>&page=<?php echo $this->_var['pager']['page']; ?>&sort=<?php echo $this->_var['pager']['search']['sort']; ?>&have=1<?php if ($this->_var['pager']['search']['is_ship'] == 'is_shipping'): ?>&is_ship=is_shipping<?php endif; ?><?php if ($this->_var['pager']['search']['self_support'] == 1): ?>&is_self=1<?php endif; ?>"></i>
